...
static NetPatch get_para_patch_rect_v1()
{
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block1 = {
        para_patch_rect_conv1x1s1_di_1_weight,
        para_patch_rect_conv1x1s1_di_1_bias,
        para_patch_rect_convdw3x3s2_1_weight,
        para_patch_rect_convdw3x3s2_1_bias,
        para_patch_rect_conv1x1s1_dd_1_weight,
        para_patch_rect_conv1x1s1_dd_1_bias,
        para_patch_rect_conv1x1s1_dd_se_1_weight,
        para_patch_rect_conv1x1s1_dd_se_1_bias,
        para_patch_rect_conv1x1s1_di_se_1_weight,
        para_patch_rect_conv1x1s1_di_se_1_bias,
        2,
        1,
        8,
        8,
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block2 = {
        para_patch_rect_conv1x1s1_di_2_weight,
        para_patch_rect_conv1x1s1_di_2_bias,
        para_patch_rect_convdw3x3s2_2_weight,
        para_patch_rect_convdw3x3s2_2_bias,
        para_patch_rect_conv1x1s1_dd_2_weight,
        para_patch_rect_conv1x1s1_dd_2_bias,
        para_patch_rect_conv1x1s1_dd_se_2_weight,
        para_patch_rect_conv1x1s1_dd_se_2_bias,
        para_patch_rect_conv1x1s1_di_se_2_weight,
        para_patch_rect_conv1x1s1_di_se_2_bias,
        2,
        1,
        16,
        2,
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block3 = {
        para_patch_rect_conv1x1s1_di_3_weight,
        para_patch_rect_conv1x1s1_di_3_bias,
        para_patch_rect_convdw3x3s1_3_weight,
        para_patch_rect_convdw3x3s1_3_bias,
        para_patch_rect_conv1x1s1_dd_3_weight,
        para_patch_rect_conv1x1s1_dd_3_bias,
        para_patch_rect_conv1x1s1_dd_se_3_weight,
        para_patch_rect_conv1x1s1_dd_se_3_bias,
        para_patch_rect_conv1x1s1_di_se_3_weight,
        para_patch_rect_conv1x1s1_di_se_3_bias,
        1,
        1,
        16,
        1,
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block4 = {
        para_patch_rect_conv1x1s1_di_4_weight,
        para_patch_rect_conv1x1s1_di_4_bias,
        para_patch_rect_convdw3x3s1_4_weight,
        para_patch_rect_convdw3x3s1_4_bias,
        para_patch_rect_conv1x1s1_dd_4_weight,
        para_patch_rect_conv1x1s1_dd_4_bias,
        para_patch_rect_conv1x1s1_dd_se_4_weight,
        para_patch_rect_conv1x1s1_dd_se_4_bias,
        para_patch_rect_conv1x1s1_di_se_4_weight,
        para_patch_rect_conv1x1s1_di_se_4_bias,
        1,
        1,
        16,
        1,
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block5 = {
        para_patch_rect_conv1x1s1_di_5_weight,
        para_patch_rect_conv1x1s1_di_5_bias,
        para_patch_rect_convdw3x3s1_5_weight,
        para_patch_rect_convdw3x3s1_5_bias,
        para_patch_rect_conv1x1s1_dd_5_weight,
        para_patch_rect_conv1x1s1_dd_5_bias,
        para_patch_rect_conv1x1s1_dd_se_5_weight,
        para_patch_rect_conv1x1s1_dd_se_5_bias,
        para_patch_rect_conv1x1s1_di_se_5_weight,
        para_patch_rect_conv1x1s1_di_se_5_bias,
        1,
        1,
        16,
        1,
    ...
    static Block_Bneck_SE_Short_Desc block_patch_block6 = {
        para_patch_rect_conv1x1s1_di_6_weight,
        para_patch_rect_conv1x1s1_di_6_bias,
        para_patch_rect_convdw3x3s1_6_weight,
        para_patch_rect_convdw3x3s1_6_bias,
        para_patch_rect_conv1x1s1_dd_6_weight,
        para_patch_rect_conv1x1s1_dd_6_bias,
        para_patch_rect_conv1x1s1_dd_se_6_weight,
        para_patch_rect_conv1x1s1_dd_se_6_bias,
        para_patch_rect_conv1x1s1_di_se_6_weight,
        para_patch_rect_conv1x1s1_di_se_6_bias,
        1,
        1,
        32,
        2,
    ...
    static Block_Conv1x1_Short_Desc block_patch_postconv1x1 = {
        para_patch_rect_conv1x1_post_weight,
        para_patch_rect_conv1x1_post_bias,
        8,
    };
...
int descriptor_net_patch_short_rect(unsigned char* ucImage, int height, int width, int32_t nX, int32_t nY, int16_t ori, int *patch_size, int *sample_size, uint32_t* desc, void* net_memory)
{
    ...
    MatImg image_warp = newMat(ucImage, width, height, 1);
    Mat patch_warp = newMat(tensor, 8, 32, 1);

    // float theta = (float)ori / 4096;
    // theta = theta - 1.570796327; // theta-pi/2 梯度方向变为指纹方向

    // 不校准
    bilinear_warp_neon_rect(image_warp, patch_warp, 0, (float)nX, (float)nY, patch_size, sample_size);
