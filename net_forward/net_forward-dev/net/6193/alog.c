...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_descriptor:  306139304");
#endif
...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_enhance:  305109305");
#endif
    return SL_RET_SUCCESS;
}
...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_mask:  305109306");
#endif
    return SL_RET_SUCCESS;
}
...
{
    int32_t net_ver = 306149320;
    //N代表正式版本号，T代表测试版本号
    SL_LOGE( "net_ver:  N.306149320, build_date:%s, build_time:%s", __DATE__, __TIME__);
    get_version_patch();
    get_version_enhance();
    get_version_exp();
