...
static NetSpoof get_para_spoof_v1()
{
    ...
    static Block_Bn block1 = {
        para_conv1x1s1_di_1_weight,
        para_conv1x1s1_di_1_bias,
        para_convdw3x3s1_1_weight,
        para_convdw3x3s1_1_bias,
        para_conv1x1s1_dd_1_weight,
        para_conv1x1s1_dd_1_bias,
        1,
        1,
        8,
        1,
    ...
    static Block_Bn block2 = {
        para_conv1x1s1_di_2_weight,
        para_conv1x1s1_di_2_bias,
        para_convdw3x3s2_2_weight,
        para_convdw3x3s2_2_bias,
        para_conv1x1s1_dd_2_weight,
        para_conv1x1s1_dd_2_bias,
        2,
        1,
        16,
        4,
    ...
    static Block_Bn block3 = {
        para_conv1x1s1_di_3_weight,
        para_conv1x1s1_di_3_bias,
        para_convdw3x3s1_3_weight,
        para_convdw3x3s1_3_bias,
        para_conv1x1s1_dd_3_weight,
        para_conv1x1s1_dd_3_bias,
        1,
        1,
        16,
        4,
    ...
    static Block_Bn block4 = {
        para_conv1x1s1_di_4_weight,
        para_conv1x1s1_di_4_bias,
        para_convdw3x3s2_4_weight,
        para_convdw3x3s2_4_bias,
        para_conv1x1s1_dd_4_weight,
        para_conv1x1s1_dd_4_bias,
        2,
        1,
        24,
        4,
    ...
    static Block_Bn block5 = {
        para_conv1x1s1_di_5_weight,
        para_conv1x1s1_di_5_bias,
        para_convdw3x3s1_5_weight,
        para_convdw3x3s1_5_bias,
        para_conv1x1s1_dd_5_weight,
        para_conv1x1s1_dd_5_bias,
        1,
        1,
        24,
        4,
    ...
    static Block_Bn block6 = {
        para_conv1x1s1_di_6_weight,
        para_conv1x1s1_di_6_bias,
        para_convdw3x3s2_6_weight,
        para_convdw3x3s2_6_bias,
        para_conv1x1s1_dd_6_weight,
        para_conv1x1s1_dd_6_bias,
        2,
        1,
        32,
        4,
...
{
    static Block_Conv3x3 preconv3x3s1 = {
        para_conv3x3_weight_alipay,
        para_conv3x3_bias_alipay,
        1,
        1,
        8,
    };
    ...
    static Block_Bn block1 = {
        para_conv1x1s1_di_1_weight_alipay,
        para_conv1x1s1_di_1_bias_alipay,
        para_convdw3x3s2_1_weight_alipay,
        para_convdw3x3s2_1_bias_alipay,
        para_conv1x1s1_dd_1_weight_alipay,
        para_conv1x1s1_dd_1_bias_alipay,
        2,
        1,
        16,
        3,
    ...
    static Block_Bn block2 = {
        para_conv1x1s1_di_2_weight_alipay,
        para_conv1x1s1_di_2_bias_alipay,
        para_convdw3x3s1_2_weight_alipay,
        para_convdw3x3s1_2_bias_alipay,
        para_conv1x1s1_dd_2_weight_alipay,
        para_conv1x1s1_dd_2_bias_alipay,
        1,
        1,
        16,
        3,
    ...
    static Block_Bn block3 = {
        para_conv1x1s1_di_3_weight_alipay,
        para_conv1x1s1_di_3_bias_alipay,
        para_convdw3x3s2_3_weight_alipay,
        para_convdw3x3s2_3_bias_alipay,
        para_conv1x1s1_dd_3_weight_alipay,
        para_conv1x1s1_dd_3_bias_alipay,
        2,
        1,
        24,
        3,
    ...
    static Block_Bn block4 = {
        para_conv1x1s1_di_4_weight_alipay,
        para_conv1x1s1_di_4_bias_alipay,
        para_convdw3x3s1_4_weight_alipay,
        para_convdw3x3s1_4_bias_alipay,
        para_conv1x1s1_dd_4_weight_alipay,
        para_conv1x1s1_dd_4_bias_alipay,
        1,
        1,
        24,
        3,
    ...
    static Block_Bn block5 = {
        para_conv1x1s1_di_5_weight_alipay,
        para_conv1x1s1_di_5_bias_alipay,
        para_convdw3x3s2_5_weight_alipay,
        para_convdw3x3s2_5_bias_alipay,
        para_conv1x1s1_dd_5_weight_alipay,
        para_conv1x1s1_dd_5_bias_alipay,
        2,
        1,
        32,
        3,
    ...
    static Block_Bn block6 = {
        para_conv1x1s1_di_6_weight_alipay,
        para_conv1x1s1_di_6_bias_alipay,
        para_convdw3x3s1_6_weight_alipay,
        para_convdw3x3s1_6_bias_alipay,
        para_conv1x1s1_dd_6_weight_alipay,
        para_conv1x1s1_dd_6_bias_alipay,
        1,
        1,
        32,
        4,
    ...
    static Block_Conv1x1 postconv1x1s1 = {
        para_conv1x1s1_weight_alipay,
        para_conv1x1s1_bias_alipay,
        2,
    };
...
int spoof_check( unsigned char* src, const int width, const int height, int enable_learn, int enroll_flag, float* template_feature, int* score )
{
    ...
    SL_LOGE( "spoof_check57 init, image w = %d,h = %d,e_l=%d,e_f=%d", width, height, enable_learn, enroll_flag );

    if ( src == NULL || template_feature == NULL || score == NULL || height < 0 || width < 0 || enable_learn < 0 || enroll_flag < 0 ) {
        SL_LOGE( "spoof_check57 param error" );
        return -1;
    }

    float thre_distance = 0.0f;
    ...
    SL_LOGE( "spoof_check57 score=%d,num_exceed_distance=%d", *score, num_exceed_distance );
    return ret;
}
