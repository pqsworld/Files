...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_mistouch:  302149101");
#endif
    return 0;
}
...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_spoof:  302149101");
#endif
    return 0;
}
...
{
    int32_t net_ver = 304279101;
    //N代表正式版本号，T代表测试版本号
    SL_LOGE( "net_ver:  N.304279101, build_date:%s, build_time:%s", __DATE__, __TIME__);
    //get_version_patch();
    //get_version_enhance();
    //get_version_exp();
