...
int32_t get_version_enhance(void)
{
    ...
    SL_LOGE( "net_ver_enhance:  NOT_SUPPORT");
#endif
    return 0;
}
int32_t get_version_exp(void)
{
    ...
    SL_LOGE( "net_ver_exp:  NOT_SUPPORT");
#endif
    return 0;
}
...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_mistouch:  302145901");
#endif
    return 0;
}
...
{
#if NOT_WINSO
    SL_LOGE( "net_ver_spoof:  302145901");
#endif
    return 0;
}
int32_t get_version_spd(void)
{
    ...
    SL_LOGE( "get_version_spd:  NOT_SUPPORT");
#endif
    return 0;
}
...
{
    int32_t net_ver = 304275901;
    //N代表正式版本号，T代表测试版本号
    SL_LOGE( "net_ver:  N.304275901, build_date:%s, build_time:%s", __DATE__, __TIME__);
    //get_version_patch();
    //get_version_enhance();
    //get_version_exp();
