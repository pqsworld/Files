...
model = ResnetGenerator323_7_RSG_un_2(1,2)
...
checkpoint = torch.load(r'/home/zhangsn/enhance/checkpoints/enhance/cap3_0_1/latest_net_G.pth', map_location='cpu')
# print(checkpoint)  #
# exit()
...
#
txt_p = open("enhance_param_301.h", "w")
txt_p.write(param)
txt_p.close()
