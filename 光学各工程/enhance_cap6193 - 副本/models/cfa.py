...
class MSFA(nn.Module):
    ...
    def __init__(self, in_channels=64, out_channels=64, dilation_rate_list=[1, 2, 3, 4]):
...
class CFA(nn.Module):
    ...
    def __init__(self, 
        ...
        in_channels=64, out_channels=64, dilation_rate_list=[1, 2, 3, 4]):
