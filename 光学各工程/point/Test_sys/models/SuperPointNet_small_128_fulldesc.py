...
class SuperPointNet_small_128_fulldesc(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, input_nc=1, output_nc=65, ngf=4, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6,
                 padding_type='reflect'):
        assert (n_blocks >= 0)
        super(SuperPointNet_small_128_fulldesc, self).__init__()
        ...
        if 1:
            ...
            #     norm_layer(128),
            #     nn.ReLU(True)]
            # model_2 += [nn.ConvTranspose2d(128, 128, kernel_size=2, stride=2)]
            ...
            #     norm_layer(128),
            #     nn.ReLU(True)]
            # model_2 += [nn.ConvTranspose2d(128, 128, kernel_size=3, stride=2, padding=1, output_padding=1, bias=False)]
            ...
            model_2 += [
                ...
                norm_layer(256),
                nn.ReLU(True)]
            model_2 += [nn.ConvTranspose2d(256, 256, kernel_size=3, stride=2, padding=1, output_padding=1, bias=False)]
        else:
            model_2 = [  # nn.ReflectionPad2d(3),
                nn.Conv2d(32, 32, kernel_size=3, padding=1, bias=False),
                norm_layer(32),
            ...
            model_2 += [
                ...
                nn.ReLU(True)]
            model_2 += [nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)]
            model_2 += [nn.Conv2d(64, 128, kernel_size=1, padding=0)]
