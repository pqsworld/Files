...
def dataLoader(config, dataset='syn', warp_input=False, train=True, val=True):
    ...
    workers_train = training_params.get('workers_train', 16) # 16    get相当于一条if...else...语句。如果参数workers_train在字典training_params中，字典将返回training_params[workers_train];否则返回参数1。
