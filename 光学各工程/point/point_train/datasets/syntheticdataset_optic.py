...
class syntheticdataset_optic(data.Dataset):
    """
    """
    ...
    def __init__(
        ...
        **config,
        ...
        if self.flag6159:   # 6159图库
            ...
            root_path = '/ssd/share/op_train_data/desc_op/descop_200_180/DeepDesc_Part1/' # '/home/linwc/match/data/6193/process9800/'
