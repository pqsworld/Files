...
class SyntheticDataset_gaussian_cv2_expand93(data.Dataset):
    """
    """
    ...
    def __getitem__(self, index):
        ...
        if Wdev_left < 0:
            ...
            # imgB = F.pad(imgB, pad=(-Wdev_left, -Wdev_left), mode="constant", value=0)
            imgA = imgA[0, 8:-8, :].unsqueeze(0)   # 128 x 52
            imgB = imgB[0, 8:-8, :].unsqueeze(0)
            ...
            imgA = imgA_ext[0, 4:-4, 6:-6].unsqueeze(0)                 # cut -> [120, 40]
            ...
            imgA_part_mask = imgA_part_mask[0, 8:-8, :].unsqueeze(0)   # [120, 40]
            imgB_part_mask = imgB_part_mask[0, 8:-8, :].unsqueeze(0)
        ...
        # [1, 136, 32]
        homography = homography_centorcrop(homography, Hdev_top + 8, Wdev_left)     # [120, 40]
