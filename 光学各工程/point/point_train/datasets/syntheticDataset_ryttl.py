...
class syntheticDataset_ryttl(data.Dataset):
    """
    """
    ...
    def __init__(
        ...
        **config,
        ...
        if self.flag6159:   # 6159图库
            ...
            lib_gallery = ['tianmalight-part', 'wxncw', 'wxndw', 'tianmacw-part',
             'tianmalight', 'wxnxs', 'tianmaxs', 'wxncw-part', 
             'boedw', 'tianmadw', 'tianmacw', 'bngtest', 'bngdw', 'wxnlight']                          
            


            root_path = '/ssd/share/optic_point/desc_op_smallTTL/' # '/home/linwc/match/data/6193/process9800/'
        ...
        for lib_name in lib_gallery:
            ...
            if self.newTrans:
                ...
                match_path = Path(root_path + lib_name + '/trans_choose_net.txt')      # 'trans_info_choose.txt' 'trans'
    ...
    def __getitem__(self, index):
        ...
        trans_124to128=torch.eye(3)
        trans_124to128[0,0]=128/124
        trans_124to128[1,1]=128/124
        homography=trans_124to128@homography@torch.inverse(trans_124to128)
        if kpt_shape == (122, 30):
