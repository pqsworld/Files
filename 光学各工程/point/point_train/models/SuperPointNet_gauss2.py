...
class SuperPointNet_gauss2(torch.nn.Module):
    ...
    def __init__(self, subpixel_channel=1):
        ...
        det_h = 65
        self.inc = inconv(1, c1)            # size is constant
        self.down1 = down(c1, c2)
        self.down2 = down(c2, c3)
        self.down3 = down(c3, c4)
        # self.down4 = down(c4, 512)
        # self.up1 = up(c4+c3, c2)          # 这边为什么注释掉
        ...
        self.convPb = torch.nn.Conv2d(c5, det_h, kernel_size=1, stride=1, padding=0)        # 降维？det_h = 65
    ...
    def forward(self, x):
        ...
        # Detector Head.
        cPa = self.relu(self.bnPa(self.convPa(x4)))     # 通过BatchNorm后进入激活函数
