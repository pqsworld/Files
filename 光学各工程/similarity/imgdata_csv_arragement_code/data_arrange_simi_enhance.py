...
FRRFLAG=1
SelRatio=1 #之前是15/5
Savefold='/03transpair_enhance_label_0410/frr/'
Txtpre='Sele_Sim_Frr'
            ...
            if fileName.startswith(Txtpre):
                ...
                for line in lines:
                    ...
                    # if 1:
                        ...
                        # # 
                        line = line.replace('/00ori/','/01enhance/')
                        ...
                        savettt=temp.replace('/01enhance/',Savefold)
                        na=savettt.split('/')[:]
                        save_data_path = na[0]
...
if __name__ == '__main__':   
    ...
    transpath ="/home/zhangsn/simi_net/000_data/000_alldata/02simitxtfar/simi_txt_dk4/"
