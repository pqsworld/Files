...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], block_nums=9):
    ...
    if netG == 'resnet_9blocks':
        ...
        # from .adder import MNV3_bufen_adder
        # net = MNV3_bufen_adder(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)

        net = MNV3_bufen_new(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    elif netG == 'bufen_fast':
        # net = UNet(n_channels=1, n_classes=1)
        # net = ResnetGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
        # net = MNV3_test_large(1)
        # from .adder import MNV3_bufen_adder
        ...
        net = MNV3_bufen_test(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    elif netG == 'Unet':
        net = UNet(n_channels=1, n_classes=1)
    elif netG == 'hh':
        # net = UNet(n_channels=1, n_classes=1)
        ...
        net = MNV3_bufen_GNN(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
    else:
