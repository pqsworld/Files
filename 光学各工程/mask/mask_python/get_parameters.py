...
import copy
from models.adder import MNV3_bufen_adder
...
# uscon3x3_2 = ['conv3x3_us2']
#
postconv3x3 = ['conv3x3_post']

generateconv3x3 = ['conv3x3_generate']
# generateconv1x1 = ['conv1x1_generate']

block = [preconv3x3_1, preconv3x3_2, dsconv3x3_1, dsconv3x3_2,  dsconv3x3_3, dsconv3x3_4, block1, block2, block3, block4, block5,
         block6, block7, block8, block9, usdecon3x3_1, usdecon3x3_2, usdecon3x3_3, usdecon3x3_4, postconv3x3, generateconv3x3]
name = []
for i in block:
    name.extend(i)
...
net.to('cpu')
# print(net.model[15].adder.size())
# convw= net.model[15].adder.detach().numpy().flatten()
