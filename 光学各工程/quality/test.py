...
from util.visualizer import make_dataset, save_images
...
if __name__ == '__main__':
    ...
    for i, data in enumerate(dataset):
        ...
        # save_images(webpage, visuals, img_path, aspect_ratio=opt.aspect_ratio, width=opt.display_winsize, contents=contents,score_locate=opt.score_locate)
