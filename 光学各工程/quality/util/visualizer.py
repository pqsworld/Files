...
def save_images_n(webpage, visuals, image_path, aspect_ratio=1.0, width=256, contents=[]):
    ...
    #     links.append(image_name)
    # webpage.add_images(ims, txts, links, width=width)
# def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, contents=[],score_locate=0):
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, contents=[]):
    ...
    for label, image_numpy in visuals.items():
        ...
        #     print(image_numpy)
            ...
            # if score_locate==0:
            #     image_name = '%s_%s.bmp' % (str((classify_c[0][0].numpy()*100+0.5).astype(int)),name)
            #     print('\nscore: '+str(classify_c[0][0].numpy()))
            # else:
            # image_name = '%s_%s.bmp' % (name,str((classify_c[0][0].numpy()*100+0.5).astype(int)))
            ...
            # if (classify_c[0][0].numpy()*100+0.5).astype(int)<=50:
