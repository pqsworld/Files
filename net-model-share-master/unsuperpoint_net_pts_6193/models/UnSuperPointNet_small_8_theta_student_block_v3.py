...
class UnSuperPointNet_small_8_theta_student_block_v3(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet_small_8_theta_student_block_v3, self).__init__()
        ...
        model += [Residual(inp_dim = int(4), out_dim = int(4), k=3, stride=1)]
        model += [Residual(inp_dim = int(4), out_dim = int(4), k=3, stride=1)]

        model += [Block(kernel_size=3, in_size=int(4), expand_size=int(8), out_size=int(8),nolinear=hswish(), semodule=SeModule(int(8)), stride=1)]
        model += [Block(kernel_size=3, in_size=int(8), expand_size=int(16), out_size=int(16),nolinear=hswish(), semodule=SeModule(int(16)), stride=1)]
