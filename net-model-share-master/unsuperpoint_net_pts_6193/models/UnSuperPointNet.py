...
class UnSuperPointNet(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet, self).__init__()
        ...
        # Detector Head Score.
        self.convPa_score = torch.nn.Conv2d(c4, c5, kernel_size=3, stride=1, padding=1)
        self.bnPa_score = nn.BatchNorm2d(c5)
        self.convPb_score = torch.nn.Conv2d(c5, 1, kernel_size=1, stride=1, padding=0)
        self.bnPb_score = nn.BatchNorm2d(1)
        # Detector Head Position.
        self.convPa_position = torch.nn.Conv2d(c4, c5, kernel_size=3, stride=1, padding=1)
        self.bnPa_position = nn.BatchNorm2d(c5)
        self.convPb_position = torch.nn.Conv2d(c5, 2, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        # Score Head.
        cPa_score = self.relu(self.bnPa_score(self.convPa_score(x4)))
        ...
        # Position Head.
        cPa_position = self.relu(self.bnPa_position(self.convPa_position(x4)))
