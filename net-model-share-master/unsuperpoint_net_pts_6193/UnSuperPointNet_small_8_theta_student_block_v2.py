...
class UnSuperPointNet_small_8_theta_student_block_v2(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet_small_8_theta_student_block_v2, self).__init__()
        ...
        model += [Residual(inp_dim = int(4), out_dim = int(4), k=3, stride=1)]
        model += [Residual(inp_dim = int(4), out_dim = int(8), k=3, stride=1)]
        model += [Residual(inp_dim = int(8), out_dim = int(16), k=3, stride=1)]
