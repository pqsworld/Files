...
class UnSuperPointNet_small_8_theta_04_04_teacher(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet_small_8_theta_04_04_teacher, self).__init__()
        ...
        model += [Residual(inp_dim = int(16), out_dim = int(32), k=3, stride=1)]        

        model += [Residual(inp_dim = int(32), out_dim = int(32), k=3, stride=2)]
        model += [Residual(inp_dim = int(32), out_dim = int(32), k=3, stride=2)]
        model += [Residual(inp_dim = int(32), out_dim = int(32), k=3, stride=2)]
...
class UnSuperPointNet_small_8_theta_04_04_student(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet_small_8_theta_04_04_student, self).__init__()
        c1, c2, c3, c4, c5, d1 = 64, 64, 128, 128, 256, 256
        det_h = 1
        model = [  # nn.ReflectionPad2d(3),
            nn.Conv2d(1, 4, kernel_size=3, padding=1, bias=False),
