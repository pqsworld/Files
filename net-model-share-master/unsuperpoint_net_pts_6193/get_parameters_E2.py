...
pthpath = r'/data/yey/work/6191/unsuperpoint/logs/1125_correct_noise5_sift180_denseE2_t15_91_nonorm_144_mask_nomatch_extend_smask96_e4800/checkpoints/superPointNet_396200_desc.pth.tar'
...
def list_layers(layer):
    layers = []
    if isinstance(layer, Block_E2_Rot8) or isinstance(layer, enn.SequentialModule):
...
print(count)
res += '#endif\n'
res += '//1128_e2_parameters: {:d}\n'.format(params_num)
with open('1128_e2_result.h', 'w') as f:
    f.write(res)
