...
pthpath = r'./logs/0116_correct_noise0_sift180_14_t20-5_93_nonorm_144_mask_e4800_nomatch_extend_ori5dist_cos_addFA_wbmask_addnormalFA/checkpoints/superPointNet_406800_desc.pth.tar'
...
print(count)
res += '#endif\n'
res += '//0217_93014_desc_parameters: {:d}\n'.format(params_num)
with open('0217_93014_desc_result.h', 'w') as f:
    f.write(res)
