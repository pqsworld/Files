...
def get_heatmap_unsuperpoint(semi, block_size=8):
...
class SuperPointFrontend_torch(object):
    ...
    ** note: the input, output is different from that of SuperPointFrontend
    ...
    def nms_fast(self, in_corners, H, W, dist_thresh):
        ...
        out = corners[:, inds_keep]  # corners可能已经无序
        values = out[-1, :]
    ...
    def getPtsFromHeatmap(self, heatmap):
        ...
        pts[0, :] = ys # abuse of ys, xs  # 为什么颠倒x,y
        pts[1, :] = xs
    ...
    def run(self, inp, onlyHeatmap=False, train=True, onlyouts=False):
        ...
        # flatten detection
        heatmap = get_heatmap_unsuperpoint(semi)
