...
class UnSuperPointNet_small_4_desctheta(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """
    def __init__(self, subpixel_channel=1):
        super(UnSuperPointNet_small_4_desctheta, self).__init__()
    ...
    def forward(self, x):
        ...
        x4 = self.model(x)  # encoder output
         ...
         # Score Head.
        semi_theta = self.nonlinear(self.theta(x4))
