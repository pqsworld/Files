...
#pthpath = r'./checkpoints/6193quality_13/293_net_G.pth'#v1
#pthpath = r'./checkpoints/6193quality_33/300_net_G.pth'
pthpath = r'./checkpoints/6193quality_xiaomi_101/300_net_G.pth' #v2
...
for i in range(len(layers)):
    ...
    if conv is not None:
        ...
        res += 'static short para_quality_' + \
               name[count] + \
               '_weight[{0}] = '.format(
...
res += 'static int ' + \
       'para_quality_magnification_factor[{0}] = '.format(
...
print(count)
res += '#endif\n'
#with open('6193quality_result_33_300_v2_regress_short.h', 'w') as f:
with open('6193quality_result_xiaomi_101_300_v2_regress_short.h', 'w') as f:
    f.write(res)
