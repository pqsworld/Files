...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_latest_freq', type=int, default=540, help='frequency of saving the latest results')
        ...
        parser.add_argument('--lr', type=float, default=0.01, help='initial learning rate for adam') #0.0002
        parser.add_argument('--lr1', type=float, default=0.005, help='initial learning rate for adam') #0.0005
        parser.add_argument('--lr2', type=float, default=0.005, help='initial learning rate for adam') #0.0002
        ...
        parser.add_argument('--lambda_L2', type=float, default=10.0, help='weight for L1 loss')
