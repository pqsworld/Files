...
def list_layers(layer):
    layers = []
    if isinstance(layer, nn.Sequential) or isinstance(layer,DepthwiseSeparableConvolution) or isinstance(layer,UPconv_un_222)  :
...
model =  ResnetGenerator323_7_diconv128_un_2(1,2)
...
net_names = [
    ...
    'featrues_deconv4_2',
    'featrues_deconv5',
    'featrues_deconv5_1x1_1',
    'featrues_deconv5_1x1_2',
    'featrues_resnet1_1',
    'featrues_resnet1_2',
    'featrues_resnet1_3',
    'featrues_resnet1_4',
...
checkpoint = torch.load(r'/home/zhangsn/enhance/checkpoints/enhance/dicon_4_1_1/latest_net_G.pth', map_location='cpu')
# print(checkpoint)
# exit()
...
#
txt_p = open("enhance_param_411.h", "w")
txt_p.write(param)
txt_p.close()
